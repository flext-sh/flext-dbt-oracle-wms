...
class FlextDbtOracleWmsProtocols(FlextProtocols):
    """DBT Oracle WMS protocols extending FlextProtocols with DBT Oracle WMS-specific interfaces.
    ...
    class WmsIntegrationProtocol(FlextProtocols.Domain.Service, Protocol):
        ...
        def extract_wms_inventory_data(
            self, wms_config: dict[str, object], extraction_config: dict[str, object]
        ...
        def sync_wms_to_warehouse(
            self, wms_data: list[dict[str, object]], warehouse_config: dict[str, object]
        ) -> FlextResult[dict[str, object]]:
    ...
    class TransformationProtocol(FlextProtocols.Domain.Service, Protocol):
        ...
        def calculate_wms_kpis(
            self, wms_data: list[dict[str, object]], kpi_config: dict[str, object]
        ) -> FlextResult[list[dict[str, object]]]:
    ...
    class QualityProtocol(FlextProtocols.Domain.Service, Protocol):
        ...
        def validate_wms_inventory_accuracy(
            self, wms_data: list[dict[str, object]], accuracy_rules: dict[str, object]
        ) -> FlextResult[dict[str, object]]:
    ...
    class PerformanceProtocol(FlextProtocols.Domain.Service, Protocol):
        ...
        def tune_wms_data_extraction(
            self, extraction_config: dict[str, object], tuning_config: dict[str, object]
        ) -> FlextResult[dict[str, object]]:
    ...
    DbtOracleWmsProtocol = DbtProtocol
    DbtWmsIntegrationProtocol = WmsIntegrationProtocol
    DbtWmsModelingProtocol = ModelingProtocol
    DbtWmsTransformationProtocol = TransformationProtocol
    DbtWmsMacroProtocol = MacroProtocol
    DbtWmsQualityProtocol = QualityProtocol
    DbtWmsPerformanceProtocol = PerformanceProtocol
    DbtWmsMonitoringProtocol = MonitoringProtocol
