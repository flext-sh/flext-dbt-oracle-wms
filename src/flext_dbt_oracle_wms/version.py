"""Project metadata for flext dbt oracle wms."""
...
class FlextDbtOracleWmsVersion(FlextProjectVersion):
    """Structured metadata for the flext dbt oracle wms distribution."""
