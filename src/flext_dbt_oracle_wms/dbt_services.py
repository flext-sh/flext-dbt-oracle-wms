...
class FlextDbtOracleWmsWorkflowService:
    ...
    def __init__(
        ...
        # TODO(@developer): Initialize WMS client properly (https://github.com/flext-team/flext-dbt-oracle-wms/issues/1)  # noqa: FIX002 - Tracked in issue #1
        self.client = None  # Will need to be properly initialized
