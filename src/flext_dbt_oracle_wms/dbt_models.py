...
class FlextDbtOracleWmsItemDimension(FlextModels):
...
class FlextDbtOracleWmsLocationDimension(FlextModels):
...
class FlextDbtOracleWmsInventoryFact(FlextModels):
...
class FlextDbtOracleWmsShipmentFact(FlextModels):
