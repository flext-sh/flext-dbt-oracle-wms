...
```yaml
        1  # Generated by `flext-infra codegen conform` for flext-dbt-oracle-wms — DO NOT EDIT.
        2  version: 2
        3  updates:
...
**Classe**: Insecure Configuration · **Local**: `pyproject.toml:606`
...
```toml
      602  all = true
      603  in_place = true
      604  sort_first = ["build-system", "dependency-groups", "project", "tool"]
      605  
>>>   606  [tool.uv]
      607  link-mode = "copy"
      608  
      609  [tool.vulture]
      610  exclude = ["*/_protocols/*"]
```
