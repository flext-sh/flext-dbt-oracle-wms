# Triagem Semgrep — flext-sh/flext-dbt-oracle-wms

Gerado do dump da plataforma Semgrep (deployment `datacosmos`, 2026-08-06).

Bead de rastreio: `mro-p57t.10`
...
| 4 | medium | high | `uv-missing-dependency-cooldown` | `pyproject.toml` | 606 | |
...
Dados brutos: `~/semgrep-violations/by-repo/flext-sh__flext-dbt-oracle-wms.json`
